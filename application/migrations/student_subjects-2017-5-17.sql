...
--
-- Table structure for table `block_section`
--
...
--
-- Dumping data for table `block_section`
--
...
DROP TABLE IF EXISTS `bsection`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bsection` (
  `bsection_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `countries` VALUES (1,'phillipines','2017-03-09 10:53:54','2017-03-09 10:53:57'),(2,'usa','2017-03-09 10:54:14','2017-03-09 10:54:16'),(3,'india','2017-03-09 10:54:36','2017-03-09 10:54:38'),(4,'canada','2017-03-09 10:54:45','2017-03-09 10:54:46'),(5,'uk','2017-03-09 10:54:53','2017-03-09 10:54:54'),(6,'israel','2017-03-09 10:55:00','2017-03-09 10:55:02');
...
INSERT INTO `posts` VALUES (1,1,'amanda','cabrera','2017-03-08 20:18:57','2017-03-08 20:21:32'),(2,2,'anthony','cabrera','2017-03-08 20:19:08','2017-03-08 20:19:08'),(3,3,'ronaldo','cabrera','2017-03-08 20:19:10','2017-03-08 20:19:10'),(4,4,'anthony','dela cruz','2017-03-08 20:40:11','2017-03-08 20:50:40'),(5,5,'oscar','cabrera','2017-03-08 20:40:16','2017-03-08 20:40:16');
...
--
-- Table structure for table `student_bsection_match`
--

DROP TABLE IF EXISTS `student_bsection_match`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `student_bsection_match` (
  `student_id` int(5) DEFAULT NULL,
  `block_section` varchar(20) DEFAULT NULL,
  `semester_number` varchar(20) DEFAULT NULL,
  `semester_id` int(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `student_bsection_match`
--

LOCK TABLES `student_bsection_match` WRITE;
/*!40000 ALTER TABLE `student_bsection_match` DISABLE KEYS */;
INSERT INTO `student_bsection_match` VALUES (106,'BCSD','Second Semester',54),(174,'BCSA','Second Semester',54);
/*!40000 ALTER TABLE `student_bsection_match` ENABLE KEYS */;
UNLOCK TABLES;
